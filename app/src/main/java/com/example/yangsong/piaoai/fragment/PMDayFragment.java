...
public class PMDayFragment extends BaseFragment implements OnChartValueSelectedListener, PMView {
    private final static String TAG = PMDayFragment.class.getSimpleName();
