...
public class PMMonthFragment extends BaseFragment implements OnChartValueSelectedListener, PMView {
    private final static String TAG = PMMonthFragment.class.getSimpleName();
    ...
    public PMMonthFragment(Activity activity, String indext) {
