...
public class PMTimeFragment extends BaseFragment implements OnChartValueSelectedListener, PMView {
    private final static String TAG = PMTimeFragment.class.getSimpleName();
    ...
    public PMTimeFragment(Activity activity, String indext) {
