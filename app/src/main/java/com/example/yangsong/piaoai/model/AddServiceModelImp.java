 ...
 * 邮箱：597210600@qq.com
 */
public class AddServiceModelImp extends BaseModel implements BindingModel<Msg> {

    private Context context = null;
    private ServiceApi serviceApi;
    private CompositeSubscription mCompositeSubscription;

    public AddServiceModelImp(Context mContext) {
        super();
        context = mContext;
    ...
    public void binding(Map<String, String> map, final IBaseRequestCallBack<Msg> iBaseRequestCallBack) {
        mCompositeSubscription.add(serviceApi.addDeviceServiceInfo(map)
