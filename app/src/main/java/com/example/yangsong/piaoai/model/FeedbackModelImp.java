 ...
 * 邮箱：597210600@qq.com
 */
public class FeedbackModelImp extends BaseModel implements FeedbackModel<Msg> {
    ...
    @Override
    public void addRemark(String phoneNumber, String remark,final IBaseRequestCallBack<Msg> iBaseRequestCallBack) {
        mCompositeSubscription.add(serviceApi.addRemark(phoneNumber,remark)
