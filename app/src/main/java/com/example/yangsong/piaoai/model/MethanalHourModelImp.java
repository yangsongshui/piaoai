...
public class MethanalHourModelImp extends BaseModel implements PMDataModel<PMBean> {
    private Context context = null;
    private ServiceApi serviceApi;
    private CompositeSubscription mCompositeSubscription;

    public MethanalHourModelImp(Context mContext) {
        super();
        context = mContext;
    ...
    public void GetData(Map<String, String> map, final IBaseRequestCallBack<PMBean> iBaseRequestCallBack) {
        mCompositeSubscription.add(serviceApi.getHourDataByJIAQUAN(map)
