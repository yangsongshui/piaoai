 ...
 * 邮箱：597210600@qq.com
 */
public class MinModelImp extends BaseModel implements MsgModel<FLZDevice> {

    private Context context = null;
    private ServiceApi serviceApi;
    private CompositeSubscription mCompositeSubscription;

    public MinModelImp(Context mContext) {
        super();
        context = mContext;
    ...
    public void loadWeather(Map<String, String> map, final IBaseRequestCallBack<FLZDevice> iBaseRequestCallBack) {
        mCompositeSubscription.add(serviceApi.minFlzCMNum(map)
