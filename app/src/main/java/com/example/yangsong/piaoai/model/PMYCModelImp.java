...
public class PMYCModelImp extends BaseModel implements PMDataModel<TVOC> {
    private Context context = null;
    private ServiceApi serviceApi;
    private CompositeSubscription mCompositeSubscription;

    public PMYCModelImp(Context mContext) {
        super();
        context = mContext;
    ...
    public void GetData(Map<String, String> map, final IBaseRequestCallBack<TVOC> iBaseRequestCallBack) {
        mCompositeSubscription.add(serviceApi.getHistoryDataByPM10ForYC(map)
