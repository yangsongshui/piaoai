 ...
 * 邮箱：597210600@qq.com
 */
public class PswModelImp extends BaseModel implements PswModel<Msg> {

    private Context context = null;
    private ServiceApi serviceApi;
    private CompositeSubscription mCompositeSubscription;

    public PswModelImp(Context mContext) {
        super();
        context = mContext;
    ...
    @Override
    public void updatePwd(Map<String, String> map, final IBaseRequestCallBack<Msg> iBaseRequestCallBack) {
        mCompositeSubscription.add(serviceApi.updatePwd(map)
