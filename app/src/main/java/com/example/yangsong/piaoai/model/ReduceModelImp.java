 ...
 */
public class ReduceModelImp extends BaseModel implements MsgModel<FLZDevice> {

    private Context context = null;
    private ServiceApi serviceApi;
    private CompositeSubscription mCompositeSubscription;

    public ReduceModelImp(Context mContext) {
        super();
        context = mContext;
    ...
    public void loadWeather(Map<String, String> map, final IBaseRequestCallBack<FLZDevice> iBaseRequestCallBack) {
        mCompositeSubscription.add(serviceApi.reduceFlzCMNum(map)
